...
@ManagedBean(name = "Testoverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "TESTOverview", beanType = BeanType.PORTLET)
public class Testoverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
